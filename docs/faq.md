...
1. Run `./node_modules/.bin/esbuild ./src/runner.js --bundle --platform=node --external:sharp --external:qrcode-terminal --external:jimp --external:link-preview-js --target=node20 --outfile=out.js` to create a single JS file
