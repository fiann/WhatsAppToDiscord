...
> ⚠️ **Alpha release notice:** Version `v2.0.0-alpha.8` introduces the Baileys 7 migration and is **not yet stable**. Expect rapid updates and potential breaking changes until a stable release lands.
