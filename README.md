...
> ⚠️ **Alpha release notice:** Version `v2.0.0-alpha.8` ships the Baileys 7 migration and is considered **unstable**. Expect rapid changes and breaking issues until a stable tag is published.
...
immutable version tags (for example, `v2.0.0-alpha.8`) and moving channels:
