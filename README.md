...
> ⚠️ **Alpha release notice:** Version `v2.0.0-alpha.1` ships the Baileys 7 migration and is considered **unstable**. Expect rapid changes and breaking issues until a stable tag is published.
